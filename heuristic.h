            ...
            if ((0 == local_soln_feasible || 0 == best_soln_feasible))
            {
                for (int c = 0; c < num_clauses; c++)
                {
                    ...
                    if (org_clause_weight[c] == top_clause_weight)
                        ...
                        if(best_soln_feasible == 1 && local_soln_feasible == 0 && tries < 15){
                            ...
                            clause_weight[c] = double(org_clause_weight[c]/max_soft_weight) * tries;
                        }else{
                            clause_weight[c] = 0;
                        }
                    }
            ...
            else
            {
                if ((0 == local_soln_feasible || 0 == best_soln_feasible) && num_hclauses > 0)
                {
                    ...
                    if(best_soln_feasible == 1 && local_soln_feasible == 0 && tries < 5){
                            // clause_weight[c] = 0.1 * tuned_org_clause_weight[c];
                             clause_weight[c] = (double)1/num_sclauses * tries;
                        }else{
                            clause_weight[c] = 0;
                        }
                }
